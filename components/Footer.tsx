    ...
    <footer className='block w-full bg-dark' aria-labelledby='footer-heading'>
      ...
      <div className='mx-auto px-5 text-white lg:px-24 lg:text-start text-center'>
        <div className='py-12  md:flex md:items-center md:justify-between '>
          ...
          <div className='mt-8 text-white md:mt-0 lg:flex lg:gap-x-6'>
            {blok?.footer_links?.map((nestedBlok: any) => (
              <StoryblokComponent blok={nestedBlok} key={nestedBlok._uid} />
            ))}
          </div>
        </div>
        <div className='border-t  border-gray border-opacity-30 py-12 md:flex md:items-center md:justify-between'>
